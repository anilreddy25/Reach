//
//  ScrollPagertwo.swift
//  AgentRestocks
//
//  Created by Azharuddin on 21/09/18.
//  Copyright © 2018 NumberMall. All rights reserved.
//

import UIKit

@objc public protocol ScrollPagerDelegatetwo: NSObjectProtocol {
    @objc optional func scrollPager(scrollPager: ScrollPagertwo, changedIndex: Int)
}




    @IBDesignable public class ScrollPagertwo: UIView, UIScrollViewDelegate{
        ...
        @IBOutlet public weak var delegate: ScrollPagerDelegatetwo!
