...
//  Demoview
//
//  Created by Azharuddin on 01/09/18.
...
open class LinearProgressBar: UIView {
    ...
    public var progressBarColor: UIColor = UIColor.red
    public var heightForLinearBar: CGFloat = 4
    ...
    override public init(frame: CGRect) {
        ...
        self.progressBar = UIView(frame: CGRect(x: 0, y:580, width: 0, height: heightForLinearBar))
    ...
    override open func layoutSubviews() {
        ...
        self.Method()
        frame = CGRect(x: frame.origin.x, y:580, width: frame.width, height: heightForLinearBar)
    ...
    func Method()
    {
        ...
        if self.heightForLinearBar == 320
        {
           
        }
        if self.heightForLinearBar == 375
        {
            
        }
        if self.heightForLinearBar == 414
        {
            frame = CGRect(x: frame.origin.x, y:580, width: frame.width, height: heightForLinearBar)
        }
    }
    ...
    open func startAnimating(){
        ...
        if !isAnimating {
            ...
            UIView.animate(withDuration: 1.0, delay:0, options: [], animations: {
                self.frame = CGRect(x: 0, y: self.frame.origin.y+100, width: self.widthForLinearBar, height: self.heightForLinearBar)
    ...
    open func stopAnimating(completion: (() -> Void)? = nil) {
        ...
        UIView.animate(withDuration: 1.0, animations: {
            self.progressBar.frame = CGRect(x: self.widthForLinearBar, y: self.frame.origin.y+100, width: self.widthForLinearBar, height: 0)
