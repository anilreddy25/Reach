...
class CustomSegmentedContrl: UIControl {
    ...
    @IBInspectable var commaSeperatedButtoniamge:UIImage? =  nil {
    ...
    func updateView() {
        ...
        let buttonimagesvalue = commaSeperatedButtoniamge
        ...
        for buttonTitle in buttonTitles {
            ...
            button.setBackgroundImage(buttonimagesvalue, for:.normal)
